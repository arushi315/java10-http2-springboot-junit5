...
public class Messages {
    ...
    public static final int SERVER_ERROR_KEY = 1002;
    public static final int BAD_REQUEST_ERROR = 1001;
    public static final int UNAUTH_JWT_ERROR = 2002;
    public static final int SERVER_UNMAPPED_MESSAGE = 1003;
    public static final int NOT_ACCEPTABLE_ERROR = 1004;
